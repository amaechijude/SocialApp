# Generated by Django 5.0.2 on 2024-04-04 11:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_pics', django_resized.forms.ResizedImageField(crop=None, default='anon.png', force_format=None, keep_meta=True, quality=70, scale=None, size=[1920, 1080], upload_to='profile_images')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', django_resized.forms.ResizedImageField(crop=None, force_format=None, keep_meta=True, quality=70, scale=None, size=[400, 800], upload_to='stories')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='thread.profile')),
            ],
        ),
